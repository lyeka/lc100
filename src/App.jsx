 ...
 *        路由：/, /leetcode, /problem/:id, /agent, /agent/:id, /go, /go/:id, /mysql, /mysql/:id, /redis, /redis/:id, /kafka, /kafka/:id, /design-system
...
import { KafkaDetail } from '@/pages/KafkaDetail'
    ...
    <BrowserRouter>
      <Layout>
        <Routes>
          ...
          <Route path="/kafka/:id" element={<KafkaDetail />} />
