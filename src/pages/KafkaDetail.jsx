/**
 * [INPUT]: react-router (useParams, Link), @/data/kafkaInterviews, @/components/ui/button, @/components/CodeBlock, @/components/LearnedStamp, @/components/CopyPromptToAI, @/lib/interviewPrompts, lucide-react (ExternalLink)
