/**
 * [INPUT]: react-router (useSearchParams, Link), react (useState), @/data/interviews
...
export function AgentHome() {
  ...
  /* ── 筛选 ── */
  const filtered = interviews.filter(q => {
  ...
  const grouped = interviewCategories.reduce((acc, cat) => {
