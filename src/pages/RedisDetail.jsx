/**
 * [INPUT]: react-router (useParams, Link), @/data/redisInterviews, @/components/ui/button, @/components/CodeBlock, @/components/LearnedStamp, @/components/OpenInChatGPT
...
function buildPrompt(q) {
  ...
  if (q.codeExample) {
    parts.push('', '【代码示例】', '```' + (q.codeExample.language || 'redis'), q.codeExample.code, '```')
